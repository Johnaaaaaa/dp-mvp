// data/stories.ts
// Egyszerű demo-story a /test oldalhoz.
// NEM típusozzuk rá Story-ra, hogy a TS ne sírjon az extra mezők miatt.
...
export const demoStory = {
  ...
  questions: [
    {
      id: 'q1',
      // itt maradhat a text, a /test UI ezt tudja használni
      text: {
      ...
      options: [
        {
          ...
          // engine-nek: ha valahol számolunk, legyen egy egyszerű 0–10 value
          value: 8,
          // domain-spec pontszámok – a mostani dpEngine nem használja,
          // de később még jól jöhetnek.
